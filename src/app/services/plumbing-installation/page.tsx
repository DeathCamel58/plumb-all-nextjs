...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Plumbing Installation';
  ...
  const ogImageUrl = 'og-plumbing-installation-gray-pipes';
  const path = '/services/plumbing-installation';
