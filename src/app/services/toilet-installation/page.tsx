...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Toilet Installation';
  ...
  const path = '/services/toilet-installation';
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="w-full mb-12 text-center">
          ...
          <p className="text-xl max-w-4xl mx-auto mb-8">
            A properly installed toilet is essential for a functional <Link href="/services/bathroom-plumbing" className="text-theme-3 hover:underline">bathroom</Link>. Whether you&#39;re wondering <Link href="/news/article/when-is-it-time-for-a-new-toilet" className="text-theme-3 hover:underline">when it&#39;s time for a new toilet</Link> or installing one during a renovation, <Link href="/services" className="text-theme-3 hover:underline">Plumb-All&#39;s</Link> expert technicians ensure your toilet is installed correctly, preventing leaks and ensuring optimal performance for years to come. We also offer <Link href="/services/plumbing-repair" className="text-theme-3 hover:underline">plumbing repair</Link> and <Link href="/services/sink-repair" className="text-theme-3 hover:underline">sink repair</Link> services to address all your bathroom plumbing needs.
          </p>
        </div>
