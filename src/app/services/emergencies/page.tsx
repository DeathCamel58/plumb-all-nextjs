    ...
    <div className="min-h-screen">
      ...
      <div className="relative w-full h-64 md:h-96">
        ...
        <div className="absolute inset-0 background-theme-4/50 bg-opacity-50 flex items-center justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Plumbing Emergencies</h1>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="w-full mb-12">
          <h1 className="text-4xl font-bold mb-6 text-center">24/7 Emergency Plumbing Services</h1>
