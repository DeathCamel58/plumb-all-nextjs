          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="flex flex-col md:flex-row mb-8 items-center">
              ...
              <div className="md:w-2/3">
                ...
                <p className="mb-4">
                  At Plumb-All, we specialize in all types of septic repair, including <Link href="/alternative-septic" className="text-theme-3 hover:underline">alternative septic</Link>, septic drain repair, and <Link href="/septicrepair" className="text-theme-3 hover:underline">leach field repair</Link>. We&#39;re also skilled at addressing any plumbing issue you may have. Don&#39;t just take our word for it – check out our outstanding reviews on Google Maps and Yelp to see what our satisfied customers have to say.
                </p>
                <p className="mb-4">
